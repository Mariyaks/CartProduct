                            ...
                            <form method='post' action="{{ route('update', ['id' => $product->id]) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" name="name" class="form-control border border-2 p-2" value="{{ $product->name }}">
                                        @error('name')
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <input type="file" name="image"  class="form-control border border-2 p-2" value="{{ $product->image }}"> 
                                        @error('image')
                                            <p class='text-danger inputerror'>{{ $message }} </p>
                                        @enderror
                                        @if ($product->image)
                                            <img src="{{ asset($product->image) }}" alt="Current Image" class="img-fluid mt-2" style="max-width: 100px;">
                                        @endif
                                    </div> 
