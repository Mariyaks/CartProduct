                ...
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <div class="me-3 my-3 d-flex justify-content-between">
                            ...
                            <a class="btn bg-gradient-dark  mx-3" href="{{ route('category') }}">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-sm font-weight-bold">{{$categroy->id}}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-sm font-weight-bold">{{$categroy->name}}</span>
                                            </td>
                                            
                                            <td class="align-middle">
                                                <a rel="tooltip" class="btn btn-success btn-link"
                                                    href="{{ url('categoryedit/'. $categroy->id) }}" data-original-title=""
                                                    title="">
                                                ...
                                                <a rel="tooltip" class="btn btn-danger btn-link"
                                                    href="{{url('delete/'. $categroy->id) }}" data-original-title="" 
                                                    title="">
